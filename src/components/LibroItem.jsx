...
const LibroItem = ({ libro, onSeleccionarLibro }) => {
  ...
  return (
    <article className={styles.libroItem}> 
      <div className={styles.frontal}>
       <div className={styles.img}>

       </div>
       <p>{libro.title}</p> 
      </div>
      <div className={styles.tejueloContent}>
       <div className={styles.tejuelo}>
        ...
        <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"  viewBox="0 0 16 16">
        ...
        <svg className={styles.delete} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"  viewBox="0 0 16 16">
